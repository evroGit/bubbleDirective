 ...
 */
(function () {
    angular.module("bubbleDirectives", [])
    ...
    function bubble() {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                var MIN_SIZE = 20, MAX_SIZE = 80,  MIN_OFFSET = 10,   MAX_OFFSET = 90,
                ...
                var bubbleStyle = '<style type="text/css">' +'*{-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;}'+
